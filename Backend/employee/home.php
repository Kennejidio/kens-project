...
<body>
    ...
    <div class="w3-sidebar w3-bar-block w3-collapse w3-card w3-animate-left w3-black side-bar-width" id="mySidebar">
        ...
        <img src="../../Public/images/employee_profile.jpg" alt="student" class="profile-image" />
        <p class="w3-center">
        ...
        <a href="#" class="w3-bar-item w3-button w3-hover-text-pink w3-hover-none w3-center"><?php echo $_SESSION['user']['username']; ?></a>        
