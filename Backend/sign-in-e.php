...
<body>
    ...
    <div class="d-flex aligns-items-center justify-content-center">
        <div class="shadow mt-5 pb-5" style="background-color: white; min-height: auto; width: 25rem">
            ...
            <div class="mt-3">
                <img src="../../Public/images/employee.png" alt="Student" style="height: 45px; width: 50px"
                    class="center" />
                <div style="text-align: center">
                    <h4 class="text-color">EMPLOYEE PORTAL</h4>
                </div>
            </div>

            <!-- //* Form Sign-in Starts Here -->

            <form action="sign-in-e.php" method="post">
                ...
                <div class="container text-center">
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <a href="sign-up-e.php" class="link-color">Register</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col">
